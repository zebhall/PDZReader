...
def main():
    ...
    # ]
    # sampsuffixes = [
    #     "normal-cupped short-beams.pdz",
    #     "normal-cupped long-beams.pdz",
    #     "5mm from nose.pdz",
    #     "5mm from nose short-beams.pdz",
    #     "10mm from nose.pdz",
    # ]
    ...
    #     sampnamelist = []
    #     for suff in sampsuffixes:
    #         sampnamelist.append(f"{samp} {suff}")
    #     allsamps.append(sampnamelist)

    # print(allsamps)
    # print(f"{len(allsamps)=}")
    ...
    for pdz_fname in pdzpaths:
        ...
        df = pd.DataFrame(
            data={
                "Info": [
                    f"{pdz.name} ({pdz.spectrum1.sourceVoltage:.0f}kV / {pdz.spectrum1.sourceCurrent:.2f}uA / {pdz.spectrum1.filterDesciption} / {pdz.spectrum1.timeLive:.2f}s live)"
                ]
                * 2048,
